...
import com.ebookfrenzy.masterdetailflow.SiteData.SiteList;
...
public class WebsiteListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(SiteList.ITEMS));
    }

    public class SimpleItemRecyclerViewAdapter
            extends RecyclerView.Adapter<SimpleItemRecyclerViewAdapter.ViewHolder> {

        private final List<SiteList.SiteItem> mValues;

        public SimpleItemRecyclerViewAdapter(List<SiteList.SiteItem> items) {
            mValues = items;
        }
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public SiteList.SiteItem mItem;
